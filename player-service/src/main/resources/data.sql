...
VALUES
  ('Inferno Blaze', 'http://example.com/skins/inferno_blaze.jpg', 900),
  ('Frostbite Fury', 'http://example.com/skins/frostbite_fury.jpg', 1200),
  ('Nightshade Viper', 'http://example.com/skins/nightshade_viper.jpg', 650)
ON CONFLICT (id) DO NOTHING;
